...
class Post(models.Model):
    ...
    # image = models.ImageField(blank=True) 기존크기변경전
    ...
    created_at = models.DateTimeField(auto_now_add=True) # create될때 딱 한번 현재시각
    updated_at = models.DateTimeField(auto_now=True) # 변경될때마다 현재시각
